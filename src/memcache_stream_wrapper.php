 ...
 *
 * stream_wrapper_register('memcache', 'AppEngine\MemcacheStreamWrapper', $url_flags);
 *
 * @see https://github.com/GoogleCloudPlatform/appengine-symfony-starter-project/issues/11
 *
...
class  MemcacheStreamWrapper
{
     ...
     * @return mixed
     */
    protected function createKeyFromPath($path)
    {
        return $path;
    }
     ...
     * @param mixed $key
     */
    protected function removeStatCache($key)
    {
        unset($this->statcache[$key]);
    }

    /**
     * @param mixed $stat_args
     *
     * @return array
     */
